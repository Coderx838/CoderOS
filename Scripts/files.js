...
const fileSystem = JSON.parse(localStorage.getItem("coderOS_fileSystem") || localStorage.getItem("fileSystem")) || {
    id: "root",
    type: "folder",
    name: "Root",
    children: [
        { id: "desktop-id",   type: "folder", name: "Desktop",   children: [
            { id: "welcome-file-id", type: "file", name: "welcome.md", content: "# Welcome to CoderOS!\nYour personal web operating system built for programming, web experiments, and productivity.", children: [] },
            { id: "quicknotes-file-id", type: "file", name: "todo.txt", content: "- Try Code Studio IDE\n- Test CoderShell terminal\n- Customize developer profile", children: [] }
        ] },
        { id: "projects-id", type: "folder", name: "Projects", children: [
            { id: "particle-file-id", type: "file", name: "particle.js", content: "// Particle network canvas animation\nconsole.log('Particle engine active');", children: [] },
            { id: "api-file-id", type: "file", name: "api_mock.json", content: '{\n  "system": "CoderOS",\n  "version": "1.0.0",\n  "status": "online"\n}', children: [] }
        ] },
        { id: "scripts-id", type: "folder", name: "Scripts", children: [
            { id: "deploy-file-id", type: "file", name: "deploy.sh", content: '#!/bin/bash\necho "Building and deploying CoderOS..."\ngit status\necho "Deployment complete!"', children: [] }
        ] },
        { id: "docs-id", type: "folder", name: "Docs", children: [
            { id: "cheatsheet-file-id", type: "file", name: "cheatsheet.md", content: "# CoderOS Cheatsheet\n- sysinfo: display system metrics\n- eval <code>: run JS in terminal\n- code: open IDE", children: [] }
        ] }
    ]
}
