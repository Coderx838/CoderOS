...
//Code Studio variables
const codeStudio = document.querySelector("#codeStudio");
const codeStudioContent = document.querySelector("#codeStudioContent");
const codeStudioClose = document.querySelector("#closeCodeStudioWindow");
const codeStudioOpen = document.querySelector("#openCodeStudioWindow");
const codeStudioMaximizeButton = document.querySelector("#codeStudioMaximizeButton");

//Dev Tools variables
const devTools = document.querySelector("#devTools");
const devToolsContent = document.querySelector("#devToolsContent");
const devToolsClose = document.querySelector("#closeDevToolsWindow");
const devToolsOpen = document.querySelector("#openDevToolsWindow");
const devToolsMaximizeButton = document.querySelector("#devToolsMaximizeButton");
...
initializeWindow(codeStudio, codeStudioContent, codeStudioOpen, codeStudioClose, codeStudioMaximizeButton);
initializeWindow(devTools, devToolsContent, devToolsOpen, devToolsClose, devToolsMaximizeButton);
