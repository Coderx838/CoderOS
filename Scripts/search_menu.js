...
apps = [
    {name: "Code Studio",
     content: `<div id="searchMenuCodeStudio" class="search_menu_app_icon clickable no_select" data-window="codeStudio">
                    <img class="app_icon_svg" src="Images/code_editor.svg" alt="Code Studio">
                </div>`},
    {name: "Dev Tools",
     content: `<div id="searchMenuDevTools" class="search_menu_app_icon clickable no_select" data-window="devTools">
                    <img class="app_icon_svg" src="Images/dev_tools.svg" alt="Dev Tools">
                </div>`},
    {name: "Terminal",
     content: `<div id="searchMenuTerminal" class="search_menu_app_icon clickable no_select" data-window="terminal">
                    <img class="app_icon_svg" src="Images/terminal.svg" alt="Terminal">
                </div>`},
    {name: "Files",
    ...
    {name: "Browser",
     content: `<div id="searchMenuBrowser" class="search_menu_app_icon clickable no_select" data-window="browser">
                    <img class="app_icon_svg" src="Images/browser.svg" alt="Browser">
                </div>`},
    {name: "CoderOS Station",
     content: `<div id="searchMenuWelcomeScreen" class="search_menu_app_icon clickable no_select" data-window="welcomeScreen">
                    <img class="app_icon_svg" src="Images/Favicon.svg" alt="Station">
                </div>`},
    {name: "Notes",
